//
// Changes: 
//    Maurice Hollmann 121015: 
//      -changes in predict(): added test if variable x is NULL before releasing it 
//       to avoid matlab crashes under macos 10.8.1 and Matlab 2010a
//
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
void predict(mxArray *plhs[], const mxArray *prhs[], struct svm_model *model, const int predict_probability)
{
  ...
  //MHFIXME: changed - to avoid crashes of matlab under macosx 10.8.1, Matlab R2010a!
	if(x != NULL)
    free(x);
