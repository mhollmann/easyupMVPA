% Author: - Jimmy Shen (jimmy@rotman-baycrest.on.ca)
%
% Description:
...
%  The niiData-header struct (example):
%   niiData.hdr.hk:
%
%        sizeof_hdr: 348
%         data_type: ''
...
%     intent_name: ''
%           magic: ''
%      originator: [32 32 10 0 0]
%
%  
%
function nii = makeNIIfromVolume(varargin)
